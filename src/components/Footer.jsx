    ...
    <footer id="tentang" className="footer">
      <Reveal>
        <div className="footer-grid">
          <div>
            ...
            <div className="socials">
              {[<FaInstagram />, <FaYoutube />, <FaTiktok />].map(
                (icon, index) => (
                  <motion.button
                    key={index}
          ...
          <div>
            ...
            {[
              ...
              [
                <MdLocationOn />,
                "JL. Melawai XII No.2 Kav.207A, RT.4/RW.6, Melawai, Kec. Kby. Baru, Jakarta Selatan.",
              ],
            ].map(([icon, text]) => (
              <p key={text} className="contact-line">
                <span className="contact-icon">{icon}</span>
        ...
        <div className="copyright">
          © 2026 DKV 1ST GENERATION. All Rights Reserved.
        </div>
      </Reveal>
    </footer>
  );
